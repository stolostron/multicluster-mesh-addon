...
.PHONY: gen-chart
gen-chart: ## Update Chart.yaml with VERSION
...
verify-gen: gen ## Verify generated files are up to date
	@if ! git diff --quiet HEAD -- chart/crds/ chart/templates/clusterrole.yaml chart/Chart.yaml pkg/apis/**/zz_generated.*.go; then \
