...
# TODO: Use kustomized or helm instead of sed
.PHONY: deploy
deploy: gen push ## Deploy the controller to the cluster
	kubectl apply -f config/crd/
	kubectl apply -f config/deploy/
	sed 's|image:.*|image: $(IMG)|' config/deploy/06-deployment.yaml | kubectl apply -f -

# TODO: Add deploy-local target for local development (kind/minikube) without pushing to registry

.PHONY: undeploy
undeploy: gen ## Remove the controller from the cluster
